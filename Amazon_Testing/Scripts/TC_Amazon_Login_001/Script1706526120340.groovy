...
WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_email'), Sign_in)

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Amazon Sign In/input_password'), Password)
